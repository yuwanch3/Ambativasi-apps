...
export default function ReviewJawabanUjian() {
  ...
  // 🔒 FUNGSI KEMBALI KE SOAL DENGAN STATUS JAWABAN TERKUNCI VIA ASYNCSTORAGE
  ...
  const loadReviewData = async () => {
    try {
      ...
      try {
        ...
        console.log("Avatar gagal disinkronkan di review ujian", e);
      }
  ...
  // 💡 Modal Peringatan khusus dipicu dari Menu Navigasi Sidebar dan Foto Profil Navbar
        ...
        <View style={styles.modalOverlay}>
          ...
          >
            ...
            <Text style={[styles.modalTitle, { color: colors.text }]}>
              {language === "id"
                ? "Meninggalkan Halaman Review Ujian?"
                : "Leave Exam Review Page?"}
            </Text>
            <Text style={[styles.modalSubtitle, { color: colors.subtext }]}>
              {language === "id"
                ? "Apakah kamu yakin ingin keluar dari halaman review hasil ujian ini?"
                : "Are you sure you want to exit this exam review page?"}
            </Text>
            <SoundTouchableOpacity
