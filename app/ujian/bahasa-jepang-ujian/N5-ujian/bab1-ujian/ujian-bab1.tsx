...
function DraggableChip({ abjad, teks, onDropSuccess, dropZoneLayout, isUsed, isReadOnly }: DraggableChipProps) {
...
export default function SubUjianNihongo() {
  ...
  const [exitTarget, setExitTarget] = useState<"back" | "dashboard" | "profile" | "pengaturan" | "chat" | "shareProgress">("back");
  ...
  const handleBukaModalKeluar = (target: "back" | "dashboard" | "profile" | "pengaturan" | "chat" | "shareProgress" = "back") => {
