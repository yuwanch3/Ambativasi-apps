  ...
  const handleStartQuiz = () => {
    ...
    router.push({
      ...
      params: {
        ...
        judul_bab:
          language === "id" ? "Kuis Surah Al-Fatihah" : "Surah Al-Fatihah Quiz",
      },
    });
  };
  ...
  const levels = [
    {
      ...
      judul:
        language === "id"
          ? "Materi Tajwid Al-Fatihah"
          : "Al-Fatihah Tajweed Material",
                ...
                >
                  ...
                  >
                    ...
                    <SoundTouchableOpacity
                      ...
                      onPress={() =>
                        router.push(
                          "/materi/tajwid-islam/al-fatihah/videosurahAl-fatihah",
                        )
                      }
                    >
                      <Ionicons
