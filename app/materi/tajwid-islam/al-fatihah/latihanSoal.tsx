...
export default function SubUjianNihongo() {
  ...
  const ambilSoalLangsungDariAI = async () => {
    try {
      setLoadingAI(true);
      const finalSumberData = sumber_data
        ? String(sumber_data)
        : "TJ_AL_FATIHAH";
      ...
      Alert.alert(
        "Error Gemini",
        error.message || "Gagal memuat soal kuis Tajwid.",
      );
    } finally {
      setLoadingAI(false);
    }
  ...
  // 💡 SUPPORT UNTUK SEMUA TARGET NAVIGASI TERMASUK CHAT
