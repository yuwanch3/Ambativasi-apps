...
export default function VideoBabScreen() {
      ...
      <View style={styles.mainContent}>
        ...
        >
          <Text style={[styles.videoTitleText, { color: colors.text }]}>
            {language === "id"
              ? `Video Pembelajaran: ${data.judulId}`
              : `Learning Video: ${data.judulEn}`}
          </Text>
          ...
          {!isFullScreen && (
            ...
            >
              ...
              <Text style={[styles.descriptionBody, { color: colors.subtext }]}>
                {language === "id"
                  ? `Silakan tonton video tutorial di atas untuk memahami materi ${data.judulId} pada Chemical EOR secara mendalam. Kamu bisa menjeda (pause), memajukan, atau mempercepat video menggunakan kontrol bawaan yang tersedia di layar pemutar.`
                  : `Please watch the tutorial video above to gain an in-depth understanding of ${data.judulEn} in Chemical EOR. You can pause, fast-forward, or speed up the video using the built-in controls available on the player screen.`}
              </Text>
            </View>
          )}
        </ScrollView>
