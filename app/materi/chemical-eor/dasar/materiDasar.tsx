...
export default function MateriScreen() {
  ...
  const handleStartQuiz = () => {
    ...
    router.push({
      ...
      params: {
        tipe_sumber: "text",
        sumber_data: "CHEMICAL_EOR_DASAR",
        judul_bab:
          language === "id"
            ? "Latihan Soal - Chemical EOR Dasar"
            : "Practice Questions - Basic Chemical EOR",
      },
    });
  };
  ...
  const levels = [
    {
      ...
      judul: language === "id" ? "Materi DASAR" : "Basic Material",
        ...
        >
          ...
          {levels.map((level) => {
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {language === "id"
                            ? "Buka Materi PDF (materiDasar)"
                            : "Open PDF Material (materiDasar)"}
                        </Text>
                      </View>
                      <Animated.View
                        style={{
                    ...
                    >
                      <TouchableOpacity
                        ...
                        onPress={() =>
                          router.push(
                            "/materi/chemical-eor/dasar/pdfDasar" as any,
                          )
                        }
                      >
                        <View
            ...
            return (
              ...
              >
                <View style={styles.levelCardLeft}>
                  {/* 💡 TELAH DIPERBAIKI: DIPASANG KOMPONEN IMAGE */}
                  <View style={styles.levelBadge}>
                    <Image
                      source={level.image}
                      style={styles.badgeImage}
