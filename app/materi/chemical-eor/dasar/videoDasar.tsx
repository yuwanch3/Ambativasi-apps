        ...
        >
          ...
          {!isFullScreen && (
            ...
            >
              ...
              >
                {language === "id"
                  ? "Silakan tonton video tutorial di atas untuk memahami konsep dasar, jenis bahan kimia, mekanisme dorongan, hingga kriteria pemilihan lapangan. Kamu bisa menjeda (pause), memajukan, atau mempercepat video menggunakan kontrol bawaan yang tersedia di layar pemutar."
                  : "Please watch the tutorial video above to understand the basic concepts, types of chemicals, drive mechanisms, and criteria for selecting the field. You can pause, fast-forward, or speed up the video using the built-in controls available on the player screen."}
              </Text>
            </View>
          )}
        </ScrollView>
