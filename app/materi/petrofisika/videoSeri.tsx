...
export default function VideoSeriScreen() {
          ...
          {!isFullScreen && (
            ...
            >
              ...
              <Text style={[styles.descriptionBody, { color: colors.subtext }]}>
                {language === "id"
                  ? `Silakan tonton video tutorial di atas untuk memahami ${data.judulId} secara mendalam. Kamu bisa menjeda (pause), memajukan, atau mempercepat video menggunakan kontrol bawaan yang tersedia di layar pemutar.`
                  : `Please watch the tutorial video above to gain an in-depth understanding of ${data.judulEn}. You can pause, fast-forward, or speed up the video using the built-in controls available on the player screen.`}
              </Text>
            </View>
          )}
        </ScrollView>
