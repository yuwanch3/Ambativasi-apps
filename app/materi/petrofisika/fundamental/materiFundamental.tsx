...
export default function MateriScreen() {
  ...
  // --- STATE MODAL KONFIRMASI LATIHAN SOAL ---
    ...
    try {
      ...
      if (session === null) {
        ...
        try {
          ...
          console.log("Avatar gagal dimuat di materi petrofisika screen", e);
        }
  ...
  // 💡 EKSEKUSI PINDAH KE HALAMAN LATIHAN SOAL SETELAH DIKONFIRMASI
  const handleStartQuiz = () => {
    setIsQuizModalOpen(false);
    router.push({
      pathname: "/materi/petrofisika/fundamental/latihanSoal",
      params: {
        tipe_sumber: "pdf",
        sumber_data: "PETROFISIKA_FUNDAMENTAL",
        judul_bab:
          language === "id" ? "Kuis Petrofisika Fundamental" : "Petrofisika Fundamental Quiz",
      },
    });
  };
  ...
  const levels = [
    {
      id: 1,
      image: require("../../../../assets/icons/icon-materi.png"),
      judul:
        language === "id"
          ? "Materi Petrofisika fundamental"
          : "Petrophysics fundamental Material",
      sub: language === "id" ? "PDF dan Video" : "PDF and Video",
      path: "",
    },
    {
      id: 2,
      image: require("../../../../assets/icons/icon-soal.png"),
      judul: language === "id" ? "Latihan Soal" : "Practice Questions",
      sub: language === "id" ? "Petrofisika Fundamental" : "Petrophysics fundamental",
      path: "",
    },
  ];
  ...
  return (
    ...
    >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {language === "id"
                            ? "Buka Materi PDF (materi petrofisika)"
                            : "Open PDF Material (petrophysics material)"}
                        </Text>
                      </View>
                      <Animated.View
                    ...
                    >
                      <TouchableOpacity
                        ...
                        onPress={() =>
                          router.push(
                            "/materi/petrofisika/fundamental/pdfFundamental" as any,
                          )
                        }
                      >
                        <View
                    ...
                    <TouchableOpacity
                      ...
                      onPress={() =>
                        router.push(
                          "/materi/petrofisika/fundamental/videoFundamental",
                        )
                      }
                    >
                      <Ionicons
                      ...
                      />
                      <Text
                        style={[styles.subMenuItemText, { color: colors.text }]}
                      >
                        {language === "id"
      ...
      <Modal visible={isQuizModalOpen} transparent animationType="fade">
        <View
          style={[
            styles.modalOverlay,
