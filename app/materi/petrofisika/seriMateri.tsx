...
export default function MateriSeriScreen() {
  ...
  const levels = [
    ...
    },
    {
      ...
      sub: language === "id" ? "10 Soal Petrofisika" : "10 Petrophysics Questions",
      path: "",
    },
  ];
                ...
                >
                  ...
                  >
                    <SoundTouchableOpacity
                      ...
                      onPress={() =>
                        router.push(
                          `/materi/petrofisika/pdfSeri?seri=${seriId}` as any,
                        )
                      }
                      activeOpacity={0.7}
                    >
                    ...
                    <SoundTouchableOpacity
                      ...
                      onPress={() =>
                        router.push(
                          `/materi/petrofisika/videoSeri?seri=${seriId}` as any,
                        )
                      }
                    >
                      <Ionicons
